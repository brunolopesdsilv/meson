...
''')
    ...
    def generate_cs_target(self, target: build.BuildTarget):
        ...
        commands += compiler.get_optimization_args(self.get_target_option(target, 'optimization'))
        commands += compiler.get_debug_args(self.get_target_option(target, 'debug'))
